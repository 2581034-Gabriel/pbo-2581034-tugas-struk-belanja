...
public class Main {
    public static void main(String[] args){
        ...
        System.out.println(nama1 + jumlah1 + "x" + harga1 + "=" + totalSemua1);
        System.out.println(nama2 + jumlah2 + "x" + harga2 + "=" + totalSemua2);
        System.out.println(nama3 + jumlah3 + "x" + harga3 + "=" + totalSemua3);
